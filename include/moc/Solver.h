...
#include <math.h>
//#include "accel/cuda/OTFonGPU.h"
//#include "hip/OTFsolver.h"
#endif
...
protected:
  ...
  /** A pointer to the 3DTracks array, only for GPUSolver and VectorizedSolver */
  Track3D** _tracks_3D;  	
...
public:
  ...
  virtual void initializeSolver(solverMode solver_mode);
